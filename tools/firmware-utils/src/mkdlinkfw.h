...
#define SN_LEN 20
#define SW_VERSION_LEN 12
#define REGION_LEN 4
#define MODEL_LEN 16
#define PRODUCT_NAME_LEN 32
#define REVISION_NAME_LEN 32
#define IMAGE_TYPES_NAME_LEN 8
#define BOARD_ID_NAME_LEN 16

#define host_endian( x ) x = le32toh( x );
#define target_endian( x ) x = htole32( x );
typedef struct {
    ...
    unsigned char revision[REVISION_NAME_LEN];
    unsigned char model_name[MODEL_LEN];
    unsigned char region[REGION_LEN];
    unsigned char swversion[SW_VERSION_LEN];
} fw_header;
